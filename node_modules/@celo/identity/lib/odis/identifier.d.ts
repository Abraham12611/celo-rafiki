...
import { IdentifierPrefix, getPrefixedIdentifier } from '@celo/odis-identifiers';
 ...
 */
export declare function getObfuscatedIdentifier(plaintextIdentifier: string, identifierPrefix: IdentifierPrefix, account: string, signer: AuthSigner, context: ServiceContext, blindingFactor?: string, clientVersion?: string, blsBlindingClient?: BlsBlindingClient, sessionID?: string, keyVersion?: number, abortController?: AbortController): Promise<IdentifierHashDetails>;
/**
 ...
 */
export declare function getBlindedIdentifier(plaintextIdentifier: string, identifierPrefix: IdentifierPrefix, blsBlindingClient: BlsBlindingClient, seed?: Buffer): Promise<string>;
/**
 ...
 * @param abortController Optional Allows client to specify a timeout for the ODIS request
 */
export declare function getBlindedIdentifierSignature(account: string, signer: AuthSigner, context: ServiceContext, base64BlindedMessage: string, clientVersion?: string, sessionID?: string, keyVersion?: number, abortControlller?: AbortController): Promise<string>;
/**
 ...
 * @param blsBlindingClient Optional Performs blinding and unblinding, defaults to WasmBlsBlindingClient
 */
export declare function getObfuscatedIdentifierFromSignature(plaintextIdentifier: string, identifierPrefix: IdentifierPrefix, base64BlindedSignature: string, blsBlindingClient: BlsBlindingClient): Promise<IdentifierHashDetails>;
/**
 ...
 */
export declare const getIdentifierHash: (plaintextIdentifier: string, identifierPrefix: IdentifierPrefix, pepper: string) => string;
/**
 ...
 */
export declare function getPepperFromThresholdSignature(sigBuf: Buffer): string;
