...
class ContractKit {
    ...
    getNetworkConfig(humanReadable = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign({ stableTokens: yield this.celoTokens.getStablesConfigs(humanReadable) }, configMap);
        });
    }
    /**
    ...
    setFeeCurrency(tokenContract) {
        return __awaiter(this, void 0, void 0, function* () {
            const address = tokenContract === base_1.CeloContract.GoldToken
                ? undefined
                : yield this.registry.addressFor(tokenContract);
