...
var MultiSigWrapper = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        transactionId--;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, (0, connect_1.toTransactionObject)(this.connection, this.contract.methods.submitTransaction(destination, value, data))];
                }
            });
        });
    };
    MultiSigWrapper.prototype.confirmTransaction = function (transactionId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, connect_1.toTransactionObject)(this.connection, this.contract.methods.confirmTransaction(transactionId))];
            });
    ...
    MultiSigWrapper.prototype.getTransactionDataByContent = function (destination, txo, value) {
        if (value === void 0) { value = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var data, transactionCount, transactionsOrEmpties, wantedTransaction, confirmations;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        transactionCount = _a.sent();
                        return [4 /*yield*/, Promise.all(Array(transactionCount)
                                .fill(0)
                                .map(function (_, index) { return __awaiter(_this, void 0, void 0, function () {
                                var tx;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.getTransaction(index, false)];
                                        case 1:
                                            tx = _a.sent();
                                            if (tx.data === data && tx.destination === destination && tx.value.isEqualTo(value)) {
                                                return [2 /*return*/, __assign({ index: index }, tx)];
                                            }
                    ...
                    case 2:
                        transactionsOrEmpties = _a.sent();
                        wantedTransaction = transactionsOrEmpties.find(function (tx) { return tx !== null; });
                        if (!wantedTransaction) {
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.getConfirmations(wantedTransaction.index)];
                    case 3:
                        confirmations = _a.sent();
                        return [2 /*return*/, __assign(__assign({}, wantedTransaction), { confirmations: confirmations })];
                }
            });
        });
    };
    MultiSigWrapper.prototype.getTransaction = function (i, includeConfirmations) {
        if (includeConfirmations === void 0) { includeConfirmations = true; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, destination, value, data, executed, confirmations;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.contract.methods
                            ...
                            .call()];
                    case 1:
                        _a = _b.sent(), destination = _a.destination, value = _a.value, data = _a.data, executed = _a.executed;
                        ...
                        return [4 /*yield*/, this.getConfirmations(i)];
                    case 2:
     ...
     */
    MultiSigWrapper.prototype.getConfirmations = function (txId) {
        return __awaiter(this, void 0, void 0, function () {
            var owners, confirmationsOrEmpties, confirmations;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getOwners()];
                    case 1:
                        owners = _a.sent();
                        return [4 /*yield*/, Promise.all(owners.map(function (owner) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.contract.methods.confirmations(txId, owner).call()];
                                        case 1:
                    ...
                    case 2:
                        confirmationsOrEmpties = _a.sent();
                        confirmations = confirmationsOrEmpties.filter(function (c) { return c !== null; });
                        return [2 /*return*/, confirmations];
                }
            });
        });
    };
