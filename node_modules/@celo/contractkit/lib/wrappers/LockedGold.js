...
var LockedGoldWrapper = /** @class */ (function (_super) {
    ...
    function LockedGoldWrapper() {
         ...
         */
        _this.delegate = (0, BaseWrapper_1.proxySend)(_this.connection, _this.contract.methods.delegateGovernanceVotes);
        /**
         ...
         */
        _this.updateDelegatedAmount = (0, BaseWrapper_1.proxySend)(_this.connection, _this.contract.methods.updateDelegatedAmount);
        /**
         * Revokes delegated locked gold.
         */
        _this.revokeDelegated = (0, BaseWrapper_1.proxySend)(_this.connection, _this.contract.methods.revokeDelegatedGovernanceVotes);
        _this.getMaxDelegateesCount = function () { return __awaiter(_this, void 0, void 0, function () {
            var maxDelegateesCountHex;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection.web3.eth.getStorageAt(
                        // tslint:disable-next-line:no-string-literal
                        this.contract['_address'], 10)];
                    case 1:
                        maxDelegateesCountHex = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.default(maxDelegateesCountHex, 16)];
                }
            });
        }); };
        _this.getDelegateInfo = function (account) { return __awaiter(_this, void 0, void 0, function () {
            var totalDelegatedFractionPromise, totalDelegatedCeloPromise, delegateesPromise, fixidity, _a, _b;
            var _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        totalDelegatedFractionPromise = this.contract.methods
                            .getAccountTotalDelegatedFraction(account)
                            .call();
                        totalDelegatedCeloPromise = this.contract.methods.totalDelegatedCelo(account).call();
                        delegateesPromise = this.contract.methods.getDelegateesOfDelegator(account).call();
                        fixidity = new bignumber_js_1.default('1000000000000000000000000');
                        _c = {};
                        _a = bignumber_js_1.default.bind;
                        return [4 /*yield*/, totalDelegatedFractionPromise];
                    case 1:
                        _c.totalPercentDelegated = new (_a.apply(bignumber_js_1.default, [void 0, _d.sent()]))()
                            .multipliedBy(100)
                            .div(fixidity)
                            .toFixed() + '%';
                        return [4 /*yield*/, delegateesPromise];
                    case 2:
                        _c.delegatees = _d.sent();
                        _b = bignumber_js_1.default.bind;
                        return [4 /*yield*/, totalDelegatedCeloPromise];
                    case 3: return [2 /*return*/, (_c.totalVotesDelegatedToThisAccount = new (_b.apply(bignumber_js_1.default, [void 0, _d.sent()]))(),
                            _c)];
                }
            });
        }); };
    ...
    LockedGoldWrapper.prototype.getAccountSummary = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            var validators, nonvotingPromise, totalPromise, requirementPromise, pendingWithdrawalsPromise, accountTotalGovernanceVotingPowerPromise;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        validators = _c.sent();
                        nonvotingPromise = this.getAccountNonvotingLockedGold(account);
                        totalPromise = this.getAccountTotalLockedGold(account);
                        requirementPromise = validators.getAccountLockedGoldRequirement(account);
                        pendingWithdrawalsPromise = this.getPendingWithdrawals(account);
                        accountTotalGovernanceVotingPowerPromise = this.getAccountTotalGovernanceVotingPower(account);
                        _a = {};
                        _b = {};
                        return [4 /*yield*/, totalPromise];
                    case 2:
                        _b.total = _c.sent();
                        return [4 /*yield*/, nonvotingPromise];
                    case 3:
                        _b.nonvoting = _c.sent();
                        return [4 /*yield*/, requirementPromise];
                    case 4:
                        _a.lockedGold = (_b.requirement = _c.sent(),
                            _b);
                        return [4 /*yield*/, accountTotalGovernanceVotingPowerPromise];
                    case 5:
                        _a.totalGovernaneVotingPower = _c.sent();
                        return [4 /*yield*/, pendingWithdrawalsPromise];
                    case 6: return [2 /*return*/, (_a.pendingWithdrawals = _c.sent(),
                            _a)];
                }
            });
        });
     ...
     */
    LockedGoldWrapper.prototype.getAccountTotalGovernanceVotingPower = function (account) {
        return __awaiter(this, void 0, void 0, function () {
            var totalGovernanceVotingPower;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contract.methods
                            ...
                            .call()];
                    case 1:
                        totalGovernanceVotingPower = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.default(totalGovernanceVotingPower)];
                }
            });
        });
    };
     ...
     */
    LockedGoldWrapper.prototype.getPendingWithdrawal = function (account, index) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contract.methods.getPendingWithdrawal(account, index).call()];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3: return [4 /*yield*/, _a.apply(this, _b.concat([(_c.toBlock = _d.sent(),
                                _c)]))];
                    case 4:
                        events = _d.sent();
