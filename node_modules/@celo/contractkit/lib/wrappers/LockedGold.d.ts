import { AddressListItem as ALI } from '@celo/base/lib/collections';
...
declare type AddressListItem = ALI<BigNumber>;
 ...
 */
export declare class LockedGoldWrapper extends BaseWrapperForGoverning<LockedGold> {
    /**
     ...
     */
    delegate: (delegatee: string, delegateFraction: string | number) => CeloTransactionObject<void>;
    /**
     ...
     */
    updateDelegatedAmount: (delegator: string, delegatee: string) => CeloTransactionObject<string>;
    /**
     * Revokes delegated locked gold.
     */
    revokeDelegated: (delegatee: string, revokeFraction: string | number) => CeloTransactionObject<void>;
    getMaxDelegateesCount: () => Promise<BigNumber>;
    getDelegateInfo: (account: string) => Promise<DelegateInfo>;
    /**
     ...
     */
    getAccountTotalGovernanceVotingPower(account: string): Promise<BigNumber>;
    /**
     ...
     */
    getPendingWithdrawal(account: string, index: number): Promise<{
        value: BigNumber;
        time: BigNumber;
    }>;
    /**
