...
import { EIP712TypedData, EIP712TypesWithPrimary } from '@celo/utils/lib/sign-typed-data-utils';
import * as t from 'io-ts';
import { SequentialDelayDomain, SequentialDelayDomainOptions, SequentialDelayDomainState } from './sequential-delay';
/**
 ...
 */
export type DomainOptions<D extends Domain = Domain> = D extends SequentialDelayDomain ? SequentialDelayDomainOptions : never;
/**
 ...
 */
export type DomainState<D extends Domain = Domain> = D extends SequentialDelayDomain ? SequentialDelayDomainState : never;
/** io-ts schema for encoding and decoding domains of any standardized type */
export declare const DomainSchema: t.Type<Domain>;
export declare function domainEIP712Types(domain: Domain): EIP712TypesWithPrimary;
export declare function domainOptionsEIP712Types(domain: Domain): EIP712TypesWithPrimary;
/**
 ...
 */
export declare const domainEIP712: (domain: Domain) => EIP712TypedData;
/**
 ...
 */
export declare function domainHash(domain: Domain): Buffer;
