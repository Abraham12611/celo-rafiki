...
exports.ThresholdPoprfServer = exports.PoprfServer = exports.ThresholdPoprfClient = exports.PoprfCombiner = exports.PoprfClient = void 0;
...
class PoprfClient {
     ...
     */
    constructor(publicKey, tag, message, seed) {
        this.publicKey = publicKey;
        this.tag = tag;
        this.message = message;
        this.seed = seed;
        const blinded = poprf().blindMsg(message, seed !== null && seed !== void 0 ? seed : (0, crypto_1.randomBytes)(32));
...
class PoprfCombiner {
     ...
     */
    blindAggregate(blindedResponses) {
        if (blindedResponses.length < this.threshold) {
            return undefined;
        }
        return Buffer.from(poprf().blindAggregate(this.threshold, Buffer.concat(blindedResponses.map(Buffer.from))));
    }
    /**
...
exports.PoprfCombiner = PoprfCombiner;
/**
 ...
 */
class ThresholdPoprfClient extends PoprfClient {
    /**
     ...
     *   if this is intended (e.g. to provide for retries of requests without consuming quota).
     */
    constructor(publicKey, polynomial, tag, message, seed) {
     ...
     * blinding state present in this client.
     */
    unblindPartialResponse(response) {
        return Buffer.from(poprf().unblindPartialResp(this.polynomial, this.blindingFactor, this.tag, response));
    }
}
exports.ThresholdPoprfClient = ThresholdPoprfClient;
/**
...
class ThresholdPoprfServer {
     ...
     */
    blindPartialEval(tag, blindedMessage) {
        return Buffer.from(poprf().blindPartialEval(this.privateKeyShare, tag, blindedMessage));
    }
}
exports.ThresholdPoprfServer = ThresholdPoprfServer;
